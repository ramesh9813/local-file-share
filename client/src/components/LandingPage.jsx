...
import { 
  ...
  HardDrive, QrCode, ArrowRight, Lock 
} from 'lucide-react';
    ...
    <div className="space-y-12 py-6 animate-fadeIn">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        ...
        <div className="pt-2 flex flex-wrap items-center justify-center gap-3">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900/80 border border-slate-800 text-xs text-slate-300 shadow-sm font-normal">
          ...
          <button
            onClick={onOpenQr}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-850 text-slate-200 border border-slate-800 hover:border-indigo-500/40 text-xs font-semibold transition"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        <div 
          ...
          className="group glass-panel rounded-3xl p-6 sm:p-8 border border-slate-800 hover:border-indigo-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-indigo-500/10 cursor-pointer relative overflow-hidden flex flex-col justify-between bg-slate-900/70"
        >
          <div className="absolute -top-12 -right-12 w-40 h-40 bg-indigo-600/10 rounded-full blur-2xl group-hover:bg-indigo-600/20 transition"></div>

          <div>
            <div className="w-14 h-14 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 flex items-center justify-center mb-6 group-hover:scale-105 transition duration-300">
            ...
            <ul className="space-y-2.5 text-xs text-slate-300 mb-8 font-normal">
          ...
          <button className="w-full py-3.5 px-5 rounded-2xl bg-indigo-600 group-hover:bg-indigo-500 text-white font-semibold text-sm flex items-center justify-center gap-2 shadow-lg shadow-indigo-600/20 transition">
      ...
      {/* Feature Badges Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 max-w-4xl mx-auto pt-6 border-t border-slate-800/80">
        <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-slate-900/60 border border-slate-800">
          ...
          <div>
            <h4 className="text-sm font-semibold text-white">Full Gigabit LAN Speed</h4>
            <p className="text-xs text-slate-400 mt-1 leading-relaxed font-normal">Direct local router transfer without going out to slow external cloud servers.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-slate-900/60 border border-slate-800">
          ...
          <div>
            <h4 className="text-sm font-semibold text-white">Secure 4-Digit PIN</h4>
            <p className="text-xs text-slate-400 mt-1 leading-relaxed font-normal">Only devices entering the exact 4-digit code can access the shared files.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-slate-900/60 border border-slate-800">
          ...
          <div>
            <h4 className="text-sm font-semibold text-white">Manual Download Control</h4>
            <p className="text-xs text-slate-400 mt-1 leading-relaxed font-normal">Files never auto-download. Preview first, then download single files or all at once.</p>
          </div>
        </div>
      </div>
    </div>
